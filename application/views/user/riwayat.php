...
<select name="status" class="form-control">
    ...
    <option value="dipinjam" <?= ($this->input->get('status')=='dipinjam')?'selected':'' ?>>📚 Sedang Dipinjam</option>
    <option value="ditolak" <?= ($this->input->get('status')=='ditolak')?'selected':'' ?>>❌ Ditolak</option>
    <option value="dikembalikan" <?= ($this->input->get('status')=='dikembalikan')?'selected':'' ?>>✅ Sudah Dikembalikan</option>
</select>
</div>
...
<span class="badge-custom status-pinjam">Menunggu</span>

<?php } elseif($r->status == 'dipinjam'){ ?>
<span class="badge-custom status-pinjam">Dipinjam</span>

<?php } elseif($r->status == 'ditolak'){ ?>
<span class="badge-custom status-selesai">Ditolak</span>

<?php } elseif($r->status == 'dikembalikan'){ ?>
<span class="badge-custom status-selesai">Dikembalikan</span>
<?php } ?>
</td>
